...
export const mythicRecipes: MythicRecipeDefinition[] = [
  {
    ...
    ingredients: [
      ...
      { heroId: "combat-engineer", count: 1 },
  ...
  },
  {
    ...
    ingredients: [
      { heroId: "rookie-guard", count: 1 },
      { heroId: "slow-bot", count: 1 },
      { heroId: "core-knight", count: 1 },
      { heroId: "gravity-jailer", count: 1 },
      { heroId: "aegis-commander", count: 1 },
    ],
  ...
  },
  {
    ...
    attackStyle: "physical",
    ingredients: [
      { heroId: "scrap-gunner", count: 1 },
      { heroId: "railgun-ace", count: 1 },
      { heroId: "orbital-sniper", count: 1 },
    ],
