...
export const mythicRecipes: MythicRecipeDefinition[] = [
  ...
  },
  {
    ...
    attackStyle: "control",
    ingredients: [
      { heroId: "core-knight", count: 2 },
      { heroId: "overclock-tech", count: 1 },
      { grade: "rare", role: "tank", count: 2 },
  ...
  },
  {
    ...
    ingredients: [
      ...
      { grade: "rare", role: "support", count: 2 },
      { grade: "epic", role: "tank", count: 1 },
    ],
  ...
  },
  {
    ...
    attackStyle: "physical",
    ingredients: [
      { heroId: "spark-runner", count: 3 },
      { heroId: "pulse-ranger", count: 2 },
      { grade: "rare", role: "damage", count: 2 },
  ...
  },
  {
    ...
    attackStyle: "support",
    ingredients: [
      { heroId: "field-medic", count: 2 },
      { heroId: "credit-hacker", count: 2 },
