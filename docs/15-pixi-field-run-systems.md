...
위 값은 2026-06-05 모바일 세로 스크린샷 기준으로 중앙 녹색 유닛 필드에 맞춘 1차 보정값입니다.
...
위 값은 2026-06-05 모바일 세로 스크린샷 기준으로 노란 외곽 이동 경로에 맞춘 1차 보정값입니다.
...
현재 좌표는 2026-06-05 스크린샷 기준 1차 보정값입니다. 배포 후 실제 몬스터와 유닛 칸 위치를 보고 2차 미세조정을 진행합니다.
