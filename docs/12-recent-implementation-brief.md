...
- 기본 몬스터 체력을 전체적으로 약 1.8~2.2배 상향했습니다.
- 이후 영웅 공격력/시너지 대비 여전히 낮게 느껴져 웨이브 체력 배율을 한 번 더 상향했습니다.
- 일반 몬스터 웨이브 체력 스케일을 `1.75 + wave * 0.24`로 변경했습니다.
- 보스는 추가로 `1.35 + wave * 0.34` 배율을 더 받아 보스 웨이브 체감 난이도를 크게 올렸습니다.
