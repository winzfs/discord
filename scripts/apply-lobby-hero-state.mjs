...
text = text.replace("setUpgradeNotice(detail.title + \" 업그레이드 예약됨\")", "setHeroes((list) => list.map((hero) => hero.name === detail.title ? { ...hero, level: hero.level + 1 } : hero)); setUpgradeNotice(detail.title + \" 업그레이드 완료\")");
