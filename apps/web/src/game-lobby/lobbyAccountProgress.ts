...
export type LobbyPassRewardKind = "gold" | "crystals" | "hero-shards" | "mythic-shards" | "artifact-pieces";
...
export const lobbyPassRewards: LobbyPassReward[] = [
  ...
  { level: 3, kind: "hero-shards", amount: 12, label: "영웅 조각 상자" },
  { level: 4, kind: "gold", amount: 900, label: "골드 900" },
  { level: 5, kind: "artifact-pieces", amount: 8, label: "유물 조각 상자", featured: true },
  { level: 6, kind: "crystals", amount: 120, label: "보석 120" },
  { level: 7, kind: "hero-shards", amount: 18, label: "영웅 조각 상자" },
  { level: 8, kind: "gold", amount: 1400, label: "골드 1400" },
  { level: 9, kind: "crystals", amount: 160, label: "보석 160" },
  { level: 10, kind: "mythic-shards", amount: 30, label: "신화 조각 상자", featured: true },
  { level: 11, kind: "gold", amount: 1800, label: "골드 1800" },
  { level: 12, kind: "hero-shards", amount: 24, label: "영웅 조각 상자" },
  { level: 13, kind: "crystals", amount: 220, label: "보석 220" },
  { level: 14, kind: "artifact-pieces", amount: 14, label: "유물 조각 상자" },
  { level: 15, kind: "mythic-shards", amount: 40, label: "신화 조각 상자", featured: true },
];
