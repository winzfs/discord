...
export const HERO_STRIKE_RENDER_SCALE_MAX = 1.25;
...
export const HERO_STRIKE_MAX_PARTICLES = 96;
export const HERO_STRIKE_MAX_TEXTS = 8;
...
export const UPGRADE_REROLL_BOUNDS = { x: 145, y: 640, width: 130, height: 42 } as const;
