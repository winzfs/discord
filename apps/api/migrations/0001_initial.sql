...
CREATE INDEX IF NOT EXISTS idx_game_runs_season_score ON game_runs(season_id, score DESC);
CREATE INDEX IF NOT EXISTS idx_leaderboard_entries_season_score ON leaderboard_entries(season_id, best_score DESC);
