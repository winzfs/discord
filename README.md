...
- 영웅 스탯 `power`, `attackSpeed`, `range` 기반 설계
- 보드 전체 전투력 계산
- 웨이브 위협도 계산
- 전투력이 부족하면 적이 새고 코어 HP 감소
- 웨이브 클리어/누수/패배 결과 표시 개선

실시간 투사체/타겟팅/개별 적 HP는 이후 단계에서 확장합니다.
...
- PixiJS 테마/레이아웃 일부 파일 분리 완료
- 다음 작업은 전투력 기반 웨이브 판정 구현
